 ...
 const cardGenerator = (element) => {
   ...
   <div class="card-body">
       ...
       <img src="./images/star1.png" alt="star image" class="mx-1" height="15"> <span id="star-rating" class="fw-bold">
       ${
         element.starRating
       }</span>
   </span>
